    ...
    >
      ...
      >
        ...
        <Text style={[
          ...
          Completa los datos para crear tu cuenta y acceder a tu panel de control
        </Text>
        ...
        <View style={[styles.inputWrapper, { marginBottom: elementSpacing }]}>
          ...
          <View style={[
            ...
            <Ionicons name="person-outline" size={responsiveSizes.iconMedium} color="#FFFFFF" />
            <TextInput
              style={[
                styles.input, 
                { 
        ...
        <TouchableOpacity
          style={[
            styles.registerButton,
            {
              ...
              borderRadius: responsiveSizes.borderRadiusMedium,
              marginBottom: elementSpacing * 0.75,
            }
          ]}
